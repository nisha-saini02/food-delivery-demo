...
class SubCategoryDetailsRepositoryImplTest {

    private lateinit var repository: SubCategoryDetailsRepositoryImpl
    ...
    @Before
    fun init() {
        repository = SubCategoryDetailsRepositoryImpl(dao)
